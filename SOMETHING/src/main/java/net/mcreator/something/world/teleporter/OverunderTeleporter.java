...
public class OverunderTeleporter {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(Registries.POINT_OF_INTEREST_TYPE, registerHelper -> {
			...
			registerHelper.register(ResourceLocation.parse("something:overunder_portal"), poiType);
	...
	public OverunderTeleporter(ServerLevel level) {
		this.level = level;
	}
