...
public class FreiyrFruitDecorator extends CocoaDecorator {
	public static MapCodec<FreiyrFruitDecorator> CODEC = MapCodec.unit(FreiyrFruitDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("erikmod:freiyr_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public FreiyrFruitDecorator() {
		super(0.2f);
	}
