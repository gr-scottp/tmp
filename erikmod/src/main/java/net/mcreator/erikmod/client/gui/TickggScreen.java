package net.mcreator.erikmod.client.gui;
...
public class TickggScreen extends AbstractContainerScreen<TickggMenu> {
	private final static HashMap<String, Object> guistate = TickggMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public TickggScreen(TickggMenu container, Inventory inventory, Component text) {
