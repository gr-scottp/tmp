...
@Mod("erikmod")
public class ErikmodMod {
	public static final Logger LOGGER = LogManager.getLogger(ErikmodMod.class);
	public static final String MODID = "erikmod";

	public ErikmodMod(IEventBus modEventBus) {
