...
public class SkibididimensionDimension {
	@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
	public static class SkibididimensionSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("dextermod:skibididimension"), customEffect);
		}
	}
}
