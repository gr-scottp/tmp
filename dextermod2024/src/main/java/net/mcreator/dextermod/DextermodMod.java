...
@Mod("dextermod")
public class DextermodMod {
	public static final Logger LOGGER = LogManager.getLogger(DextermodMod.class);
	public static final String MODID = "dextermod";

	public DextermodMod(IEventBus modEventBus) {
