...
import net.mcreator.cavarli.block.LolcavarliPortalBlock;
...
public class CavarliModBlocks {
	...
	public static final DeferredBlock<Block> LOLCAVARLI_PORTAL = REGISTRY.register("lolcavarli_portal", LolcavarliPortalBlock::new);
