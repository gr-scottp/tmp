...
@Mod("cavarli")
public class CavarliMod {
	public static final Logger LOGGER = LogManager.getLogger(CavarliMod.class);
	public static final String MODID = "cavarli";

	public CavarliMod(IEventBus modEventBus) {
