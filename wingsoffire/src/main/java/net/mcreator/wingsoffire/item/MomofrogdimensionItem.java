...
package net.mcreator.wingsoffire.item;
...
public class MomofrogdimensionItem extends Item {
	public MomofrogdimensionItem() {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		if (!entity.mayUseItemAt(pos, context.getClickedFace(), itemstack)) {
			...
			if (world.isEmptyBlock(pos) && true) {
				MomofrogdimensionPortalBlock.portalSpawn(world, pos);
