package net.mcreator.wingsoffire;
...
@Mod("wingsoffire")
public class WingsoffireMod {
	public static final Logger LOGGER = LogManager.getLogger(WingsoffireMod.class);
	public static final String MODID = "wingsoffire";

	public WingsoffireMod(IEventBus modEventBus) {
