package net.mcreator.thehousetrap;
...
import net.mcreator.thehousetrap.init.ThehousetrapModEntities;
...
@Mod("thehousetrap")
public class ThehousetrapMod {
	public static final Logger LOGGER = LogManager.getLogger(ThehousetrapMod.class);
	public static final String MODID = "thehousetrap";

	public ThehousetrapMod(IEventBus modEventBus) {
		...
		ThehousetrapModEntities.REGISTRY.register(modEventBus);
